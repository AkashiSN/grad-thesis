...
\sectiondot{section}
\AtBeginDvi{\special{pdf:mapfile uptex-ms.map}}
...
\begin{center}
{\fontsize{18pt}{24pt}\selectfont \@title  \par} \vskip 24pt % japanese title
...
{\normalfont\fontsize{10pt}{20pt}\gtfamily\sffamily\selectfont}}% 見出しの書式
...
\def\fnum@Jfigure{図}
\def\fnum@Efigure{Fig\hspace{0.2mm}}
\def\fnum@Jtable{表}
\def\fnum@Etable{Table\hspace{0.2mm}}
