...
このデータには重複が含まれているので重複を削除し，各CRでの実際的なURLは10MBほどであるという仮定のうえ，ランダムな10MBを抽出し，解析データとした．
ここには約14万件のURLが含まれる．
...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm]{graph/sampled_data/sampled_data-crop.pdf}
  \caption{}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm]{graph/ratio_of_etld/ratio_of_etld_all-crop.pdf}
  \caption{}
  \label{graph:ratio_of_etld_all}
\end{figure}
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm]{graph/ratio_of_etld/ratio_of_etld_detail-crop.pdf}
  \caption{}
  \label{graph:ratio_of_etld_detail}
\end{figure}

\section{全件に対してハッシュ衝突数}
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm]{graph/hash_ccdf/hash_A_C_ccdf-crop.pdf}
  \caption{}
  \label{graph:hash_ccdf_A-C}
\end{figure}

\section{eTLDごとに分割したときにハッシュ衝突数}
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm]{graph/etld_hash_ccdf/etld_hash_ccdf-crop.pdf}
  \caption{}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm]{graph/ratio_of_pointer/ratio_of_pointer_all-crop.pdf}
  \caption{}
  \label{graph:ratio_of_etld_all}
\end{figure}
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm]{graph/ratio_of_pointer/ratio_of_pointer_detail-crop.pdf}
  \caption{}
  \label{graph:ratio_of_etld_detail}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=110mm]{graph/pointer_hash_ccdf/pointer-hash-ccdf-crop.pdf}
  \caption{}
  \label{graph:etld_hash_ccdf}
\end{figure}
