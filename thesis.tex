...
そのリストでURLの規格に合わないものを除外したのち，ICN-URLに変換しeTLDの頻度の降順に並べる．
...
\begin{figure}[h]
  \centering
  \includegraphics[width=135mm]{fig/table-crop.pdf}
...
次に，各セクションから前３文字を抜き出して配列headsとする．
同様に後３文字を抜き出して配列tailsとする．ただしパティングが含まれているセクションはパディングと元の文字との順序を入れ替える．
...
\begin{figure}[h]
  \centering
  \includegraphics[width=135mm]{fig/hash_1-crop.pdf}
  \caption{Preparation to make hash．}
  \label{fig:hash_separate}
\end{figure}
