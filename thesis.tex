...
\begin{figure}[h]
  \centering
  \includegraphics[width=120mm]{graph/sampled_data/sampled_data-crop.pdf}
  \caption{}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=120mm]{graph/ratio_of_etld/ratio_of_etld_all-crop.pdf}
  \caption{}
  \label{graph:ratio_of_etld_all}
\end{figure}
\begin{figure}[h]
  \centering
  \includegraphics[width=120mm]{graph/ratio_of_etld/ratio_of_etld_detail-crop.pdf}
  \caption{}
