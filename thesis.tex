...
\section{分割のキーにrootを含めたときのキーの割合}
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.65]{graph/ratio_of_pointer/ratio_of_pointer_all-crop.pdf}
  \caption{}
  \label{graph:ratio_of_etld_all}
\end{figure}
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.65]{graph/ratio_of_pointer/ratio_of_pointer_detail-crop.pdf}
  \caption{}
  \label{graph:ratio_of_etld_detail}
\end{figure}
