...
\documentclass[autodetect-engine, dvipdfmx-if-dvi, a4paper, ja=standard, 10pt, twocolumn]{bxjsarticle}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=75mm]{fig/url-structure-crop.pdf}
  \caption{URLの構造}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=80mm]{fig/hash_1-crop.pdf}
  \caption{ハッシュアルゴリズム}
  \label{fig:hash_A}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{eTLDごとのハッシュ値が同じURLの数の相補累積分布}
...
\begin{thebibliography}{9}
  \bibitem{Networking_Named_Content} Jacobson et.al.\,:\,Networking Named Content (2009).
